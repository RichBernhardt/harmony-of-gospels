  ...
  <svg
    ...
    <g class="contour m00-sea">
      <g>
        <path 
          id="lake-galilee" 
          :class="{ 'current-area': gdata.map.currentLocation === 'lake-galilee' }"
    ...
    <g class="county-area">
      <g>
        <path
          id="galilee"
          :class="{ 'current-area': gdata.map.currentLocation === 'galilee' }"
      ...
      <g>
        <path 
          id="samaria"
          :class="{ 'current-area': gdata.map.currentLocation === 'samaria' }"
      ...
      <g>
        <path 
          id="judea"
          :class="{ 'current-area': gdata.map.currentLocation === 'judea' }"
      ...
      <g>
        <path
          id="decapolis"
          :class="{ 'current-area': gdata.map.currentLocation === 'decapolis' }"
    ...
    <g class="cities">
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'sidon' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'tyre' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'caesarea-philippi' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'korazin' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'bethsaida' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'capernaum' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'gennesaret' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'magadan' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'magdala' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'tiberias' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'gadara' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'cana' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'nazareth' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'nain' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'aenon' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'gerasa' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'samaria-city' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'sychar' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'jacobs-well' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'arimathea' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'ephraim' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'jericho' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'bethany-at-jordan' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'bethany' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'jerusalem' }">
          <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'emmaus' }">
        <circle r=".1em" />
      ...
      <g 
        ...
        :class="{ 'current-city': gdata.map.currentLocation === 'bethlehem' }">
        <circle r=".1em" />
      ...
      <g class="shores">
        <path 
          id="galilee-shore"
          :class="{ 'current-shore': gdata.map.currentLocation === 'galilee-shore' }"
          d="m198 181c-11.9 3.52-13.8 6.44-15.9 13-.593 8.75 8.77 14.6 8.86 23.2.0389 3.74 1.1 5.49 2.6 5.91" />
        <path 
          id="decapolis-shore"
          :class="{ 'current-shore': gdata.map.currentLocation === 'decapolis-shore' }"
          d="m194 223c1.25.348 2.81-.238 4.33-1.38 3.35-2.5 6.53-7.66 5.93-11.4-.656-4.17.0603-10.1.285-15.6" />
        <path 
          id="jordan-in-judea" 
          :class="{ 'current-shore': gdata.map.currentLocation === 'jordan-in-judea' }"
          d="m190 359c-1.3 24.3 6.99 48.7 3.16 73.5" />
        <circle 
          id="galilee-samaria"
          :class="{ 'current-shore': gdata.map.currentLocation === 'galilee-samaria' }"
