  ...
  [
      ...
      (function (t, n) {
        ...
        function Mt(t, e) {
          ...
          if (d(t) && !(t instanceof St))
            return (
              $(t, "__ob__") && t.__ob__ instanceof Lt
                ? (n = t.__ob__)
                : It &&
                  !pt() &&
                  (Array.isArray(t) || v(t)) &&
            ...
            if (!P || $ || "" === $) {
              ...
              var V = !1 !== r && !it,
                ...
                K = (n._enterCb = H(function () {
                  V && (so(n, N), so(n, M)),
                    K.cancelled ? (V && so(n, L), U && U(n)) : F && F(n),
                    (n._enterCb = null);
                }));
              t.data.show ||
        ...
        (jn.config.mustUseProp = function (t, e, n) {
          ...
          (e.a = jn);
      }.call(this, n(24), n(147).setImmediate));
    },
    function (t, e, n) {
      var r = n(48)("wks"),
        o = n(32),
    ...
    function (t, e, n) {
      ...
      f(f.S + f.F * vt, "Object", {
        ...
        U.prototype[B] || n(17)(U.prototype, B, U.prototype.valueOf),
        y(U, "Symbol"),
        y(Math, "Math", !0),
        y(r.JSON, "JSON", !0);
    },
    ...
    function (t, e, n) {
          ...
          render: function (t) {
            ...
            if ("a" === this.tag)
              ...
              if (a) {
                ...
                for (var L in E) L in j.on ? j.on[L].push(E[L]) : (j.on[L] = $);
                var M = (a.data.attrs = c({}, a.data.attrs));
            ...
            if ("function" == typeof t && void 0 === t.cid) {
              ...
              var h,
                v = Pt(function (e) {
                  var r;
                  ((r = e).__esModule ||
                    (It && "Module" === r[Symbol.toStringTag])) &&
                    (e = e.default),
      ...
      (Vt.prototype.listen = function (t) {
        ...
        (Vt.prototype.confirmTransition = function (t, e, n) {
          ...
          if (C(t, l) && h === v && t.matched[h] === l.matched[v])
            return (
              this.ensureURL(),
              d(
                Ut(
          ...
          var y = (function (t, e) {
            ...
            x = [].concat(
              (function (t) {
                return Ht(t, "beforeRouteLeave", Bt, !0);
              })(_),
              this.router.beforeHooks,
              (function (t) {
                return Ht(t, "beforeRouteUpdate", Bt);
              })(m),
              w.map(function (t) {
            ...
            Ct(
              ...
              function () {
                ...
                (f.pending = null),
                  e(t),
                  f.router.app &&
                    f.router.app.$nextTick(function () {
                      n.forEach(function (t) {
                        t();
                      });
                    });
        ...
        (Vt.prototype.teardownListeners = function () {
        ...
        return (
          ...
          (e.prototype.replace = function (t, e, n) {
            ...
            this.transitionTo(
              t,
              function (t) {
                $t(j(r.base + t.fullPath)), yt(r.router, t, o, !1), e && e(t);
              },
              n
            );
          }),
              ...
              var r = function () {
                  ...
                  Gt() &&
                    t.transitionTo(Jt(), function (r) {
                      n && yt(t.router, r, e, !0), At || Qt(r.fullPath);
                    });
                },
      ...
      function Yt(path) {
        At ? kt(Xt(path)) : (window.location.hash = path);
      }
      function Qt(path) {
        At ? $t(Xt(path)) : window.location.replace(Xt(path));
      }
      var Zt = (function (t) {
          function e(e, base) {
    ...
    function (t, e, n) {
      ...
      var r = n(5),
        ...
        m = /\$([$&`']|\d\d?|<[^>]*>)/g,
        _ = /\$([$&`']|\d\d?)/g;
      n(57)("replace", 2, function (t, e, n, w) {
        return [
          function (r, o) {
            var c = t(this),
              f = null == r ? void 0 : r[e];
          ...
          function (t, e) {
            ...
            for (var $, C = "", E = 0, i = 0; i < A.length; i++) {
              ...
              if (_) {
                ...
                void 0 !== L && M.push(L);
                var N = String(e.apply(void 0, M));
              } else N = x(T, m, j, I, L, e);
              ...
              for (var v in e) {
                ...
                if (K(M, v)) h[v] = m;
                  ...
                  if (r[_] && K(r[_], v)) h[v] = m;
                    ...
                    var w = e[c];
                    if (w && ((_ = L[1]), r[_] && r[_][w] && K(r[_][w], v)))
                      h[v] = m;
                    else if (
                      ("string" == typeof m
                        ? (h[v] = l(m))
    ...
    function (t, e, n) {
      ...
      var r = n(5),
        o = n(146),
        c = n(56);
      n(57)("search", 1, function (t, e, n, f) {
        return [
          function (n) {
            var r = t(this),
              o = null == n ? void 0 : n[e];
